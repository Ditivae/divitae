Contributing to DIVIT Core
============================

The DIVIT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DIVIT Core project, and is not to be
confused with overall DIVIT Network Protocol consensus changes.

Whether a pull request is merged into DIVIT Core rests with the project merge
...
Patches that change DIVIT consensus rules are considerably more involved than
...
Where a patch set proposes to change the DIVIT consensus, it must have been
...
The project leader is the release manager for each DIVIT Core release.
