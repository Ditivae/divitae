...
RESOURCES += src/qt/Divitae.qrc src/qt/Divitae_locale.qrc

TRANSLATIONS += src/qt/locale/Divitae_bg.ts \
                src/qt/locale/Divitae_de.ts \
                src/qt/locale/Divitae_en.ts \
                src/qt/locale/Divitae_es.ts \
                src/qt/locale/Divitae_fi.ts \
                src/qt/locale/Divitae_fr.ts \
                src/qt/locale/Divitae_it.ts \
                src/qt/locale/Divitae_ja.ts \
                src/qt/locale/Divitae_pl.ts \
                src/qt/locale/Divitae_pt.ts \
                src/qt/locale/Divitae_ru.ts \
                src/qt/locale/Divitae_sk.ts \
                src/qt/locale/Divitae_sv.ts \
                src/qt/locale/Divitae_vi.ts \
                src/qt/locale/Divitae_zh_CN.ts \
                src/qt/locale/Divitae_zh_TW.ts
