...
In order to support loading of multiple wallets in Divitae-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Divitae.cpp.
...
Changes to Divitae.cpp
----------------------
Divitae.cpp is the entry point into Divitae-qt, and as such, will require some minor modifications to provide hooks for
