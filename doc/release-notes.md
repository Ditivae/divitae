DIVIT Core version *4.5.0* is now available from:  <https://github.com/Divitaeteam/Divitae/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/Divitaeteam/Divitae/issues>

Mandatory Update
==============

DIVIT Core v4.5.0 is a mandatory update for all wallets, fundamental nodes, and masternodes. It includes changes to consensus rules that require every node to update in order to stay compatible with the rest of the Divitae network.
...
zDIVIT stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by DIVIT stakers.
...
DIVIT Daemon & Client (RPC Changes)
--------------
...
### Core Features
 ...
 - #609 `6b73598b9` [MoveOnly] Remove zDIVIT code from main.cpp (presstab)
...
### GUI
 ...
 - #600 `217433561` [GUI] Only enable/disable PrivacyDialog zDIVIT elements if needed. (presstab)
...
### Wallet
 ...
 - #603 `779d8d597` Fix spending for v1 zDIVIT created before block 1050020. (presstab)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Divitae-project-translations/), the QA team during Testing and the Node hosts supporting our Testnet.
