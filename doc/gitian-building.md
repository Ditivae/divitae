...
*Setup instructions for a gitian build of DIVIT using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the DIVIT
...
- [Building DIVIT](#building-Divitae)
...
Clone the git repositories for Divitae and gitian and then checkout the Divitae version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/Divitae-crypto/Divitae.git
cd Divitae
...
Follow the instructions in [doc/release-process.md](release-process.md) in the Divitae repository
...
To build DIVIT (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the Divitae repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Divitae/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Divitae-crypto/Divitae
...
For example:
```bash
URL=https://github.com/crowning-/Divitae.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit Divitae=${COMMIT} --url Divitae=${URL} ../Divitae/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit Divitae=${COMMIT} --url Divitae=${URL} ../Divitae/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit Divitae=${COMMIT} --url Divitae=${URL} ../Divitae/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/Divitae-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Divitae-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/Divitae-build.assert
```
...
[Divitae/gitian.sigs](https://github.com/Divitae-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
