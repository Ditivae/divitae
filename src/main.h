...
// Copyright (c) 2018-2018 The DIVIT developers
...
int64_t GetProsperitynodePayment(int nHeight, int64_t blockValue, int nProsperitynodeCount = 0);
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount, bool isZDIVITStake);
