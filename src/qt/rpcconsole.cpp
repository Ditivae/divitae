                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPIVPathCustom = GetArg("zDivitaebackuppath", "");
    ...
    if(!strzPIVPathCustom.empty()) {
        ui->wallet_customzDivitaebackuppath->setText(QString::fromStdString(strzPIVPathCustom));
        ui->wallet_customzDivitaebackuppath_label->setVisible(true);
        ui->wallet_customzDivitaebackuppath->setVisible(true);
    }
...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setProsperitynodeCount(model->getProsperitynodeCountString());
        connect(model, SIGNAL(strProsperitynodesChanged(QString)), this, SLOT(setProsperitynodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DIVIT RPC console.") + "<br>" +
...
void RPCConsole::setProsperitynodeCount(const QString& strProsperitynodes)
{
    ui->prosperitynodeCount->setText(strProsperitynodes);
}
