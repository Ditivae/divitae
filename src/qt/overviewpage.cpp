...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::DIVIT)
    {
    }
...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sVITPercentage, QString& szDIVITPercentage)
{
    int nPrecision = 2;
    ...
    szDIVITPercentage = "(" + QLocale(QLocale::system()).toString(dzPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelzDIVITPercent->setText(szPercentage);
    ...
    bool showzDIVITAvailable = settingShowAllBalances || zerocoinBalance != matureZerocoinBalance;
    bool showzDIVITUnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showzDIVITImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
    ui->labelzBalanceMature->setVisible(showzDIVITAvailable);
    ui->labelzBalanceMatureText->setVisible(showzDIVITAvailable);
    ui->labelzBalanceUnconfirmed->setVisible(showzDIVITUnconfirmed);
    ui->labelzBalanceUnconfirmedText->setVisible(showzDIVITUnconfirmed);
    ui->labelzBalanceImmature->setVisible(showzDIVITImmature);
    ui->labelzBalanceImmatureText->setVisible(showzDIVITImmature);
    bool showPercentages = ! (zerocoinBalance == 0 && nTotalBalance == 0);
    ui->labelVITPercent->setVisible(showPercentages);
    ui->labelzDIVITPercent->setVisible(showPercentages);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("DIVIT")
    updateDisplayUnit();
}
