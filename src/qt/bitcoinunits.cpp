...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(DIVIT);
    unitlist.append(mDIVIT);
    unitlist.append(uDIVIT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case DIVIT:
        return QString("Divitae");
    case mDIVIT:
        return QString("mDivitae");
    case uDIVIT:
        return QString::fromUtf8("uDivitae");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case DIVIT:
            return QString("DIVIT");
        case mDIVIT:
            return QString("mDIVIT");
        case uDIVIT:
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case DIVIT:
            return QString("DIVIT");
        case mDIVIT:
            return QString("Milli-DIVIT (1 / 1" THIN_SP_UTF8 "000)");
        case uDIVIT:
            return QString("Micro-DIVIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
