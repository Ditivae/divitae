...
/* Divitae GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DIVIT"
#define QAPP_ORG_DOMAIN "Divitae.org"
#define QAPP_APP_NAME_DEFAULT "DIVIT-Qt"
#define QAPP_APP_NAME_TESTNET "DIVIT-Qt-testnet"
