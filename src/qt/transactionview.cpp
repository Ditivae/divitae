 ...
 */
    ...
    typeWidget->addItem(tr("Prosperitynode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::FNReward));
    typeWidget->addItem(tr("Received DIVIT from zDIVIT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDIVIT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDIVIT));
