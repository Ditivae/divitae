...
ClientModel::ClientModel(OptionsModel* optionsModel, QObject* parent) : QObject(parent),
                                                                        ...
                                                                        banTableModel(0),
                                                                        cachedNumBlocks(0),
                                                                        cachedProsperitynodeCountString(""),
...
QString ClientModel::getProsperitynodeCountString() const
{
...
void ClientModel::updateTimer()
{
    ...
    if (cachedNumBlocks != newNumBlocks ||
        ...
        prosperitynodeSync.RequestedProsperitynodeAttempt != prevAttempt || prosperitynodeSync.RequestedProsperitynodeAssets != prevAssets) {
        cachedNumBlocks = newNumBlocks;
        cachedReindexing = fReindex;
        cachedImporting = fImporting;
        prevAttempt = prosperitynodeSync.RequestedProsperitynodeAttempt;
        prevAssets = prosperitynodeSync.RequestedProsperitynodeAssets;
...
void ClientModel::updateMnTimer()
{
    ...
    if (!lockMain)
        return;
    QString newProsperitynodeCountString = getProsperitynodeCountString();

    if (cachedProsperitynodeCountString != newProsperitynodeCountString) {
        cachedProsperitynodeCountString = newProsperitynodeCountString;

        emit strProsperitynodesChanged(cachedProsperitynodeCountString);
    }
}
