...
{   
    ...
    if (settings.value("fShowProsperitynodesTab").toBool()) {
        prosperitynodeListPage = new ProsperitynodeList();
        addWidget(prosperitynodeListPage);
    }
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowProsperitynodesTab").toBool()) {
        prosperitynodeListPage->setClientModel(clientModel);
    }
    if (settings.value("fShowMasternodesTab").toBool()) {
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowProsperitynodesTab").toBool()) {
        prosperitynodeListPage->setWalletModel(walletModel);
    }
    if (settings.value("fShowMasternodesTab").toBool()) {
...
void WalletView::gotoProsperitynodePage()
{
    QSettings settings;
    if (settings.value("fShowProsperitynodesTab").toBool()) {
        setCurrentWidget(prosperitynodeListPage);
    }
}
