...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::FNReward:
        return tr("Prosperitynode Reward");
    ...
    case TransactionRecord::StakeMint:
        return tr("DIVIT Stake");
    case TransactionRecord::StakeZVIT:
        return tr("zDIVIT Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted DIVIT to zDIVIT");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zDIVIT");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received DIVIT from zDIVIT");
    case TransactionRecord::ZerocoinSpend_Change_zDIVIT:
        return tr("Minted Change as zDIVIT from zDIVIT Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zDIVIT to DIVIT");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zDIVIT:
        return tr("Anonymous (zDIVIT Transaction)");
    case TransactionRecord::StakeZVIT:
        return tr("zDIVIT Accumulator");
    case TransactionRecord::SendToSelf:
    default:
