...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    connect(ui->showProsperitynodesTab, SIGNAL(clicked(bool)), this, SLOT(showRestartWarning()));
}
...
void OptionsDialog::setMapper()
{
    ...
    /* Prosperitynode Tab */
    mapper->addMapping(ui->showProsperitynodesTab, OptionsModel::ShowProsperitynodesTab);
}
