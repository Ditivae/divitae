...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Divitae Core Divitae-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Divitae-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Divitae transaction") + "\n" +
                               "  Divitae-tx [options] -create [commands]   " + _("Create hex-encoded Divitae transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Divitae transaction
