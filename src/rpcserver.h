...
extern UniValue obfuscation(const UniValue& params, bool fHelp); // in rpcprosperitynode.cpp
extern UniValue getpoolinfo(const UniValue& params, bool fHelp);
extern UniValue prosperitynode(const UniValue& params, bool fHelp);
extern UniValue listprosperitynodes(const UniValue& params, bool fHelp);
extern UniValue getprosperitynodecount(const UniValue& params, bool fHelp);
extern UniValue createprosperitynodebroadcast(const UniValue& params, bool fHelp);
extern UniValue decodeprosperitynodebroadcast(const UniValue& params, bool fHelp);
extern UniValue relayprosperitynodebroadcast(const UniValue& params, bool fHelp);
extern UniValue prosperitynodeconnect(const UniValue& params, bool fHelp);
extern UniValue prosperitynodecurrent(const UniValue& params, bool fHelp);
extern UniValue prosperitynodedebug(const UniValue& params, bool fHelp);
extern UniValue startprosperitynode(const UniValue& params, bool fHelp);
extern UniValue createprosperitynodekey(const UniValue& params, bool fHelp);
extern UniValue getprosperitynodeoutputs(const UniValue& params, bool fHelp);
extern UniValue listprosperitynodeconf(const UniValue& params, bool fHelp);
extern UniValue getprosperitynodestatus(const UniValue& params, bool fHelp);
extern UniValue getprosperitynodewinners(const UniValue& params, bool fHelp);
extern UniValue getprosperitynodescores(const UniValue& params, bool fHelp);

extern UniValue fnbudget(const UniValue& params, bool fHelp); // in rpcprosperitynode-budget.cpp
