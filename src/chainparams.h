 ...
 * DIVIT system. There are three: the main network on which people trade goods
...
public:
    ...
    /** The prosperitynode count that we will allow the see-saw reward payments to be off by */
    int ProsperitynodeCountDrift() const { return nProsperitynodeCountDrift; }
    ...
    int64_t StartProsperitynodePayments() const { return nStartProsperitynodePayments; }
...
protected:
    ...
    int64_t nStartProsperitynodePayments;
