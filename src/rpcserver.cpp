...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DIVIT features */
        {"Divitae", "prosperitynode", &prosperitynode, true, true, false},
        {"Divitae", "listprosperitynodes", &listprosperitynodes, true, true, false},
        {"Divitae", "getprosperitynodecount", &getprosperitynodecount, true, true, false},
        {"Divitae", "prosperitynodeconnect", &prosperitynodeconnect, true, true, false},
        {"Divitae", "createprosperitynodebroadcast", &createprosperitynodebroadcast, true, true, false},
        {"Divitae", "decodeprosperitynodebroadcast", &decodeprosperitynodebroadcast, true, true, false},
        {"Divitae", "relayprosperitynodebroadcast", &relayprosperitynodebroadcast, true, true, false},
        {"Divitae", "prosperitynodecurrent", &prosperitynodecurrent, true, true, false},
        {"Divitae", "prosperitynodedebug", &prosperitynodedebug, true, true, false},
        {"Divitae", "startprosperitynode", &startprosperitynode, true, true, false},
        {"Divitae", "createprosperitynodekey", &createprosperitynodekey, true, true, false},
        {"Divitae", "getprosperitynodeoutputs", &getprosperitynodeoutputs, true, true, false},
        {"Divitae", "listprosperitynodeconf", &listprosperitynodeconf, true, true, false},
        {"Divitae", "getprosperitynodestatus", &getprosperitynodestatus, true, true, false},
        {"Divitae", "getprosperitynodewinners", &getprosperitynodewinners, true, true, false},
        {"Divitae", "getprosperitynodescores", &getprosperitynodescores, true, true, false},
        {"Divitae", "fnbudget", &fnbudget, true, true, false},
        {"Divitae", "preparebudget", &preparebudget, true, true, false},
        {"Divitae", "submitbudget", &submitbudget, true, true, false},
        {"Divitae", "fnbudgetvote", &fnbudgetvote, true, true, false},
        {"Divitae", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Divitae", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Divitae", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Divitae", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Divitae", "fnbudgetrawvote", &fnbudgetrawvote, true, true, false},
        {"Divitae", "fnfinalbudget", &fnfinalbudget, true, true, false},
        {"Divitae", "checkbudgets", &checkbudgets, true, true, false},
        {"Divitae", "fnsync", &fnsync, true, true, false},
        {"Divitae", "spork", &spork, true, true, false},
        {"Divitae", "getpoolinfo", &getpoolinfo, true, true, false},
        {"Divitae", "makekeypair", &makekeypair, true, true, false},
        {"Divitae", "mnspork", &mnspork, true, true, false},
        {"Divitae", "masternode", &masternode, true, true, false},
        {"Divitae", "masternodelist", &masternodelist, true, true, false},
        {"Divitae", "getmasternodestatus", &getmasternodestatus, true, true, false},
#ifdef ENABLE_WALLET
        {"Divitae", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> Divitae-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11473/\n";
}
